    ...
    public partial class CurrentSemester
{
    ...
    public partial class User
    {
        public static User FromJson(string json) => JsonConvert.DeserializeObject<User>(json, RegSystem.Model.Converter.Settings);
        public static List<User> FromJsonList(string json) => JsonConvert.DeserializeObject<List<User>>(json, RegSystem.Model.Converter.Settings);

    }

    public static class Serialize
    {
        public static string ToJson(this User self) => JsonConvert.SerializeObject(self, RegSystem.Model.Converter.Settings);
    }
